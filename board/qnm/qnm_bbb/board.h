...
static inline int board_is_qnm_bbb(void)
{
#ifdef CONFIG_TARGET_QNM_BBB
	return 1;
#else
	return 0;
#endif
...
static inline int board_is_bone_lt_family(void)
{
	return board_is_bone_lt() || board_is_qnm_bbb();
}
...
{
	return board_is_pb() || board_is_bone() || board_is_bone_lt_family() ||
